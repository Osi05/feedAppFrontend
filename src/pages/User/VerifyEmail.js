...
const VerifyEmail = () => {
  ...
  //func will call ApiUtil.js which will make the API call
  const verifyAccount = async (token) => {
    ...
    if (apiResponse.status === 1) {
      ...
      setMessage(apiResponse.payLoad); //geeting error msg from the ExceptionHandling class in the backend
    }
  };
